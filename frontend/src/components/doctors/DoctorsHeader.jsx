...
export const DoctorsHeader = ({ onAddDoctor }) => (
  <div data-testid="doctors-header" className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
    <div>
      <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Doctors</h1>
