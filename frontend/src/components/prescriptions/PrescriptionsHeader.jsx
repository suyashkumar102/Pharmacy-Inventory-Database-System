...
export const PrescriptionsHeader = ({ onNew }) => (
  <div data-testid="prescriptions-header" className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
    <div>
      <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Prescriptions</h1>
    ...
    <div className="flex flex-wrap items-center gap-3">
      <div
        data-testid="prescriptions-date-pill"
