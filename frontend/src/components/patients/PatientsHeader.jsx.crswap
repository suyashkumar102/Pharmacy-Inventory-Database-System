...
export const PatientsHeader = ({ onAddPatient }) => (
  <div data-testid="patients-header" className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
    <div>
      <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Patients</h1>
    ...
    <div className="flex flex-wrap items-center gap-3">
      <div
        data-testid="patients-date-pill"
      ...
      >
        <UserPlus className="mr-1.5 h-4 w-4" strokeWidth={2.5} />
        Add Patient
      </Button>
    </div>
  </div>
