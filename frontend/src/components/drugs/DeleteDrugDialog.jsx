...
export const DeleteDrugDialog = ({ open, onOpenChange, drug, onConfirm }) => (
  <AlertDialog open={open} onOpenChange={onOpenChange}>
    <AlertDialogContent
      data-testid="delete-drug-dialog"
    ...
    >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <AlertDialogDescription>
              ...
              <span className="font-semibold text-foreground">{drug?.name}</span> from your inventory.
      ...
      <AlertDialogFooter className="gap-2">
        <AlertDialogCancel data-testid="delete-drug-cancel" className="h-11 rounded-xl">
          Cancel
        </AlertDialogCancel>
        <AlertDialogAction
